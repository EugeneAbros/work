...
<?php get_header(); ?>
	<div class="wrapper-news">
		<div class="container-search-job article-post container-fluid">
			<div class="container">
				<div class="row">
					<h1><?php the_title(); ?></h1>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="news-page col-md-9">
					<div class="row">
						<div id="ajax-post-article" data-post="0" data-tag="">
							<?php
							$args = array(
						...
						<a id="load-more-article" href="#" data-aos="zoom-in" data-aos-once="true">Czytaj więcej</a>
					</div>
				</div>
				<div class="sidebar-news article-content col-md-3">
					<div class="social-container">
						<div class="tag-post" >
							<div class="title-social">
								<h2><?php echo pll__( 'Wybierz interesujący Cię temat:' ) ?></h2>
							</div>
								<ul id="tag-post-article">
									<li class="active">
										<a href="#"rel="tag" id=""><?php echo pll__( 'Wszystkie' ) ?></a>
									</li>
								<?php
										query_posts(array( 'post_type'=> 'dla_pracodawcy' ));
